...
- Google News RSS 新闻自动说说：可选择中国新闻、国际新闻、混合范围、关键词或自定义 Google News RSS，由 LLM 写成原创短评后定时发布。
...
| 新闻说说预览 | - | 管理员 | `新闻说说预览 [中国/国际/混合]` | 从 Google News RSS 拉取候选新闻并生成原创说说预览，不发布 |
...
| `news.once_per_day` | `true` | 每天最多成功发布一次新闻说说 |
